...
<div>
    <span class="select-none cursor-pointer text-white inline-block p-[10px_20px] bg-[#000] offer_tab_onclick" data-tabid="excursions">Excursions</span>
    <span class="select-none cursor-pointer text-white inline-block p-[10px_20px] bg-[#bf3d2a] offer_tab_onclick" data-tabid="summary">Summary</span>
</div>